...
We combine every 2 rows after the header rows since they comprise a single player's record
...
We capture a subset of information from the previous table to create a new table and extrude it to create an Average Pre Chess Rating of Opponents column
