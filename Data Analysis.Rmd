...
# Extract Subset
We capture a subset of information from the previous table to create a new table and extrube it to create an Average Pre Chess Rating of Opponents column
```{r}
columnNames <- c(
  "Player’s Name", 
  "Player’s State", 
